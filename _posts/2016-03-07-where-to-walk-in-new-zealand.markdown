...
published: true
status: publish
permalink: /WhereToWalkInNewZealand/
...
<img src="{{ site.baseurl }}/assets/WalktoIslandBay.jpg" alt="Scaling Mt Victoria" width="225" height="320" class="img-rounded"/>
</div>
...
<img src="{{ site.baseurl }}/assets/tongarirosign.jpg" alt="The start of the Tongariro Alpine Crossing, just 19.4km to go!" width="196" height="270" class="img-rounded"/>
</div>
...
<p align="center"><img src="{{ site.baseurl }}/assets/tongarirosummit.jpg" alt="The view from the summit of Mt Tongariro" width="526" height="121" class="img-rounded"/></p>
...
<img src="{{ site.baseurl }}/assets/redrocks.jpg" alt="Red rocks" width="380" height="270" class="img-rounded"/> 
</div>
<div style="float:right; padding-left:30px; padding-bottom:30px">
<img src="{{ site.baseurl }}/assets/front-page/tongariro.jpg" alt="The Emerald Lakes" width="420" height="300" class="img-rounded"/>
</div>
<p align="JUSTIFY">&nbsp;</p>
<p align="JUSTIFY">&nbsp;</p>
<p align="JUSTIFY">&nbsp;</p>
...
<div style="float:left; padding-right:30px">
<img src="{{ site.baseurl }}/assets/CapeReinga.jpg" alt="Cape Reinga" width="300" height="400" class="img-rounded"/>
</div>
...
<div style="float:right; padding-left:30px">
<img src="{{ site.baseurl }}/assets/Haruru.jpg" alt="Haruru Waterfall" width="350" height="290" class="img-rounded"/>
</div>
...
<div style="float:left; padding-right:30px">
<img src="{{ site.baseurl }}/assets/eastcapelighthouse.jpg" alt="East Cape Lighthouse" width="267" height="318" class="img-rounded"/>
</div>
...
<p align="center"><img src="{{ site.baseurl }}/assets/AlpineMemorial.jpg" alt="Aoraki Alpine Memorial" width="300" height="340" class="img-rounded"/></p>
...
<p align="center"><img src="{{ site.baseurl }}/assets/front-page/aoraki.jpg" alt="Aoraki/Mt Cook" width="471" height="324" class="img-rounded"/></p>
